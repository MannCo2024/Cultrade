...
namespace ProyectoBase
{
    ...
    internal static class Program
    {
        ...
        public static frmGuardados frmGuardados;

        public static blfChat blfChat; //Back Level Form. Le puse así pq no es toplevel, ni idea la vd como es el nombre de este tipo de form.
        ...
        public static string username = "Nombre Apellido";

        public static frmChats FrmChats
        {
            get
            {
                if (frmChats == null || frmChats.IsDisposed)
                {
                    frmChats = new frmChats();
                }
                return frmChats;
            }
        }
